import Subscription, { SubscriptionCreationAttributes } from "../models/Subscription";
import Logging from "../library/Logging";

const create = async (attributes: SubscriptionCreationAttributes) => {
    Logging.data(`Tentativa de criação de inscrição para o email: ${attributes.email}`)
